...
function isDate(obj, dateFormat) {
    return ((!isTrueNaN(new Date(obj))  /* && obj.length === dateFormat.length */) && ((TypeTester("Date")(obj) === '[object Date]')));
}
...
if (!isBrowser()) {
    ...
    module.exports.TagTester = TagTester;
    module.exports.TypeTester = TypeTester;
